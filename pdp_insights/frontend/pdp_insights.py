insight_text = {
    ...
    "dau_x_duration": "The plot shows a sharp decline in revenue with increasing session "
                      "intensity at lower values, followed by a plateau and slight rise at very high ranges.\n\n"
                      "Strategic Takeaways for Designers:\n"
                      "- Extremely intense sessions may lead to player fatigue or burnout, reducing "
                      "monetization.\n"
                      "- Designers can experiment with pacing mechanisms, micro-interactions or "
                      "prompts to optimize engagement without overwhelming users.\n"
                      "- The late-stage uptick hints at a small segment of hyper-engaged users, possibly "
                      "valuable for targeted premium features or loyalty rewards.",
    "scaled_session_duration_minutes": "The plot reveals a strong upward trend in monetization as session length "
                                       "increases.\n"
                                       "- Session duration alone might indicate higher monetization on specific days "
                                       "whereas DAU x duration reflects sustained engagement across user base"
                                       "and when DAU is very high, the quality or intensity of those "
                                       "sessions may drop.\n"
                                       "- The upward trend suggests that on days with longer average "
                                       "session durations, revenue tends to be higher.\n"
                                       "- This may reflect successful in-game loops, events or content drops that "
                                       "keep players engaged.\n"
                                       "- However when analyzing **dau_x_duration**, a different pattern emerges, "
                                       "suggesting that **higher DAU may dilute session intensity**, possibly due "
                                       "to casual or low-engagement users logging in briefly.\n\n"
                                       "Strategic Takeaways for Designers:\n"
                                       "- Session duration spikes can be leveraged for event timing or reward tuning. "
                                       "They seem to boost monetization when players are deeply engaged.\n"
                                       "- Designers should also validate that longer sessions are widespread "
                                       "(across DAU) and not limited to a niche region.\n"
                                       "- If dau_x_duration rises, it may signal that a small group is over-engaging, "
                                       "which might not scale well.",
    "engagement_level_High": "The PDP plot shows a steady linear increase in predicted revenue as the "
                             "proportion of highly engaged users increases.\n"
                             "- This confirms that the users flagged under the high engagement tier are "
                             "strong contributors to monetization, likely due to their deeper involvement "
                             "with game mechanics, in-game events or community features.\n\n"
                             "Strategic Takeaways for Designers:\n"
                             "- Designers should double down on features that deepen engagement of the users, such as "
                             "customizable content, layered progression systems, or loyalty-based events.\n"
                             "- At the same time, this trend provides a compelling case for growing this segment, "
                             "by nudging medium-tier users into higher engagement through personalized incentives or"
                             "adaptive difficulty.",
    "scaled_ingame_purchases_": "The plot shows a strong, consistent upward trend, as in-game purchases increase, "
                                "so does the predicted revenue.\n"
                                "- There is a notable inflection around 0.4, beyond which the rise in partial "
                                "dependence becomes sharper, indicating that users crossing that spending "
                                "threshold may contribute disproportionately to revenue.\n\n"
                                "Strategic Takeaways for Publishers:\n"
                                "- Publishers should consider doubling down on mid-to-high spenders by offering "
                                "dynamic bundles, loyalty perks and timed offers that scale beyond "
                                "entry-level purchases.\n"
                                "- This pattern also supports investing in pricing strategies and A/B testing "
                                "to optimize conversion rates across monetization tiers.",
    "platform_freq": "- The partial dependence curve shows a steady positive slope, indicating that as platform "
                     "frequency increases, the predicted revenue also rises.\n"
                     "- Even small increase in platform presence appear to contribute consistently to monetization.\n\n"
                     "Strategic Takeaways for Publishers:\n"
                     "- Publishers should diversify game availability across platforms, even marginal increases "
                     "in distribution (e.g, expanding to secondary consoles or optimizing for mobile/PC) "
                     "could help lift revenue.\n"
                     "- This trend supports a multi-platform publishing strategy and investing "
                     "in cross-platform compatibility for long-term monetization gains.",
    "top_genre_freq": "- The PDP shows a noticeable dip at a genre frequency of ~0.20, with an upward recovery after.\n"
                      "- The x-axis is slightly right-skewed, meaning most genre frequencies in the dataset "
                      "cluster toward the lower range.\n"
                      "- This implies only a few genres dominate the catalog, and over-reliance on them "
                      "might initially stall monetization.\n\n"
                      "Strategic Takeaways for Publishers:\n"
                      "- Diversification matter: Heavy skew toward a few popular genres can result in short-term "
                      "gains but long-term stagnation.\n"
                      "- Publishers should consider introducing niche or hybrid genres to reduce dependency on "
                      "over-saturated ones.\n"
                      "- Also, monitor how genre popularity evolves. Genres that show upward partial dependence "
                      "in low-density areas may signal emerging monetization opportunities."
